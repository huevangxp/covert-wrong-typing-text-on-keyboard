...
function convert() {
    ...
    "`":`"`, '1': "ຢ", '2': "ຟ", '3': "ໂ", '4': "ຖ", '5': "ຸ", 
    '6': "ຕ", '7': "ຫ", '8': "ຂ", '9': "ຊ", '0': "ໍ", '-': "ຍ", '=': "ໍ",

    // Row 1 (QWERTY)
    'q': 'ົ', 'w': 'ໄ', 'e': 'ຳ', 'r': 'ພ', 't': 'ະ', 
    'y': 'ິ', 'u': 'ີ', 'i': 'ຣ', 'o': 'ນ', 'p': 'ມ', '[': '໇', ']': '໘', '\\': '໙',
    
    // Row 1 (Shifted QWERTY)
    'Q': 'ົ້', 'W': 'ຽ', 'E': 'ໍ', 'R': 'ຄ', 'T': '້', 
    'Y': 'ິ້', 'U': 'ີ້', 'I': 'ຮ', 'O': 'ໜ', 'P': '໐', '{': '(', '}': ')', '|': '໗',
    ...
    // Row 2 (Shifted ASDFG)
    'A': 'ັ້', 'S': '໗', 'D': '.', 'F': ',', 'G': 'ແ', 
    'H': 'າ້', 'J': 'ສ', 'K': '໔', 'L': '໖', ':': 'ໃ້', '"': '໋',
    
    // Row 3 (ZXCVB)
    'z': 'ຊ', 'x': 'ປ', 'c': 'ແ', 'v': 'ອ', 'b': 'ຶ', 'n': 'ື', 'm': 'ທ', ',': 'ຍ', '.': '໅', '/': '໌',
    
    // Row 3 (Shifted ZXCVB)
    'Z': 'ຆ', 'X': '໒', 'C': '໓', 'V': '໘', 'B': 'ຶ້', 'N': 'ື້', 'M': 'ໆ', '<': '໘', '>': '໖', '?': '໔'
};
